            ...
            <div className="col-lg-8 posts-list">
              ...
              <div className="blog-author">
                <div className="media align-items-center">
                  <img src="http://localhost:3000/img/blog/author.png" alt="" />
                ...
                <div className="comment-list">
                  <div className="single-comment justify-content-between d-flex">
                    <div className="user justify-content-between d-flex">
                      <div className="thumb">
                        <img
                          src="http://localhost:3000/img/comment/comment_1.png"
                          alt=""
                        />
                      </div>
                      <div className="desc">
                ...
                <div className="comment-list">
                  <div className="single-comment justify-content-between d-flex">
                    <div className="user justify-content-between d-flex">
                      <div className="thumb">
                        <img
                          src="http://localhost:3000/img/comment/comment_2.png"
                          alt=""
                        />
                      </div>
                      <div className="desc">
                ...
                <div className="comment-list">
                  <div className="single-comment justify-content-between d-flex">
                    <div className="user justify-content-between d-flex">
                      <div className="thumb">
                        <img
                          src="http://localhost:3000/img/comment/comment_3.png"
                          alt=""
                        />
                      </div>
                      <div className="desc">
              ...
              <div className="blog_right_sidebar">
                ...
                <aside className="single_sidebar_widget popular_post_widget">
                  ...
                  <div className="media post_item">
                    <img
                      src="http://localhost:3000/img/post/post_1.png"
                      alt="post"
                    />
                    <div className="media-body">
                  ...
                  <div className="media post_item">
                    <img
                      src="http://localhost:3000/img/post/post_2.png"
                      alt="post"
                    />
                    <div className="media-body">
                      <a href="single-blog.html">
                  ...
                  <div className="media post_item">
                    <img
                      src="http://localhost:3000/img/post/post_3.png"
                      alt="post"
                    />
                    <div className="media-body">
                      <a href="single-blog.html">
                  ...
                  <div className="media post_item">
                    <img
                      src="http://localhost:3000/img/post/post_4.png"
                      alt="post"
                    />
                    <div className="media-body">
                      <a href="single-blog.html">
                  ...
                  <ul className="instagram_row flex-wrap">
                    <li>
                      <a href="#">
                        <img
                          className="img-fluid"
                          src="http://localhost:3000/img/post/post_5.png"
                          alt=""
                        />
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img
                          className="img-fluid"
                          src="http://localhost:3000/img/post/post_6.png"
                          alt=""
                        />
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img
                          className="img-fluid"
                          src="http://localhost:3000/img/post/post_7.png"
                          alt=""
                        />
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img
                          className="img-fluid"
                          src="http://localhost:3000/img/post/post_8.png"
                          alt=""
                        />
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img
                          className="img-fluid"
                          src="http://localhost:3000/img/post/post_9.png"
                          alt=""
                        />
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img
                          className="img-fluid"
                          src="http://localhost:3000/img/post/post_10.png"
                          alt=""
                        />
                      </a>
                    </li>
